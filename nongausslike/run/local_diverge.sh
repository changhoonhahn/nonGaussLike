...
do 
    ...
    python /Users/chang/projects/nonGaussLike/nongausslike/run/run_diverge.py $obv $div pX_scottKDE $Nref 10 100 -1
    python /Users/chang/projects/nonGaussLike/nongausslike/run/run_diverge.py $obv $div pX_scottKDE_ref $Nref 10 100 -1
    ...
    python /Users/chang/projects/nonGaussLike/nongausslike/run/run_diverge.py $obv $div pXi_ICA_scottKDE $Nref 10 100 6 30
    python /Users/chang/projects/nonGaussLike/nongausslike/run/run_diverge.py $obv $div pXi_ICA_scottKDE_ref $Nref 10 100 6 30
done 
