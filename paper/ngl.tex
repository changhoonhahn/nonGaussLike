...
\begin{abstract}
    ...
    a Gaussian form. This assumption, however, cannot be correct in detail, even 
    if the underlying LSS density field is Gaussian. We investigate the impact 
    of this assumption on two recent LSS analyses: the \cite{beutler2017}~power 
    spectrum multipole ($P_\ell$) analysis and 
    ...
    we derive the true posterior probability 
