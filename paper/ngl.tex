...
\begin{abstract}
    ...
    $P_\ell$ and $\zeta$ likelihoods, we identify significant non-Gaussianity using
    non-parametric divergence estimators on mock catalogs originally constructed 
    for covariance matrix estimation. We then use Gaussian mixture density estimation and 
    Independent Component Analysis to construct likelihood estimates that 
