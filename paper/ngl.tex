...
-- $\mathcal{N}(\overline{\bf X}^\mathrm{mock}, \mathbb{C})$. Since
...
The previous section firmly illustrates the non-Gaussianity of both 
the $P_\ell$ and $\zeta$ likelihoods. We are, however, ultimately 
interested in developing more accurate parameter inference for LSS 
studies. 
