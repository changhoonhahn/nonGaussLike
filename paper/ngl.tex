...
With accurate estimates of the likelihood distribution in hand, 
we can now quantify the impact of likelihood non-Gaussianity on the 
parameter constraints of \Beut~and~\Sinh. We begin by providing a 
brief overview of the MCMC frameworked used in the original~\Beut~and~\Sinh.
analyses.
