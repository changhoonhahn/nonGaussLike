...
Current standard \lss analyses makes a major assumption in their 
...
relatively small non-Gaussianity. Meanwhile, for the $\zeta$ likelihood, 
the high richness end of $\zeta$ contribute most to the non-Gaussianity. 
In both likelihoods, the low signal-to-noise regime contribute most to the 
non-Gaussianity.
...
distribution. The divergence between our two likelihood estimates and 
...
Among the non-nuissance parameters, only $f\sigma_8$ is impacted by $-0.44\sigma$. 
...
significantly biases their constraints. For $\log\, M_1$ and $\alpha$, the posteriors
are broadened by $42\%$ and $66\%$ and shifted by $+0.43\sigma$ and $-0.51\sigma$ 
respectively. Accounting for likelihood non-Gaussianity, significantly 
