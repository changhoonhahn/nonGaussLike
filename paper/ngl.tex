...
These estimators allow us to estimate the divergence, $\hat{D}(X_{1:n} \parallel Y_{1:m})$, directly from 
...
($\Delta \hat{D}$) quantify the discrepancy between the likelihood
...
ICA likelihood estimate. However, by examining the divergence discrepancy
as we did in Figures~\ref{fig:div_ica} and~\ref{fig:div_gmm}, we ensure that 
our likelihoods provide a better estimate of the true likelihood than the 
Gaussian pseudo-likelihood. Based on the performances of the GMM and ICA 
