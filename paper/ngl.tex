...
significant better approximate of the $\zeta$ likelihood distribution
...
case, where we are estimating a higher dimensional distribution 
...
for the $P_\ell$ likelihood, in the next section, we present an alterative 
less direct method for estimating the non-Gaussian likelihood.
...
$P_\ell$ likelihood distribution of the \Beut~analysis. 


is not feasible for the \Beut~analysis.
