...
\begin{abstract}
    ...
    $\zeta$ analysis, using the pseudo-likelihood 
...
power spectrum. All that's required is the prior distribution of the 
...
The future, however, is somewhat encouraging in this regard. The next surveys 
...
precisely quantifying the impact, it remains to be determined whether
likelihood non-Gaussianity will signficantly impact future $P_\ell$ analyses.  

For higher order statistics beyond $P_\ell$, likelihood non-Gaussianity will 
likely have a significant effect. After all, for a given survey, \cite{scoccimarro2000} 
found that the reduced bispectrum likelihood is significantly more 
non-Gaussian than the power spectrum likelihood. 
%non-Gaussianity bispectrum, which has lower signal-to-noise on large scales~\citep{sefusatti2005},
Likelihood non-Gaussianity will also significantly impact primordial 
non-Gaussianity ($f_\mathrm{NL}$) constraints from LSS~\citep[\emph{e.g.}][]{dalal2008, slosar2008, ross2013, giannantonio2014}
since the constraining power mainly come from large scales. 
...
In both likelihoods, the low signal-to-regime contribute most to the 
non-Gaussianity.
